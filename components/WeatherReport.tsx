...
const Weather = ({ style }: { style?: React.CSSProperties }) => {
    ...
    return (
        <div style={style}>
            {weather ? (
                <div className="flex rounded-full bg-white p-2 shadow-lg h-[30] items-center">
                    <img
                    ...
                    <div className="ml-2 flex flex-col">
                        ...
                        <span className="text-">{weather.main.temp}°C</span>
                        <span>Weather in {weather.name}, {weather.sys.country}</span>
                    </div>
                </div>
            ) : loading ? (
                <p>Loading...</p>
